...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSwaggerGen(options => {
            options.SwaggerDoc("v1", new OpenApiInfo
            {
                ...
                Version = "v1",
                Description = "API para gerenciamento de veículos com autenticação JWT e controle de acesso baseado em perfis.",
            ...
            options.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme{
                ...
                Description = "Insira o token JWT aqui no formato: Bearer {seu_token}"
            });
            ...
            // Configurar exemplos e descrições mais detalhadas
        });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseEndpoints(endpoints => {
            ...
            .WithDescription("Retorna uma lista paginada de todos os veículos cadastrados com filtros opcionais por nome e marca. Requer autenticação.")
            ...
            .WithSummary("Obter veículo por ID")
            .WithDescription("Retorna um veículo específico pelo seu ID. Requer autenticação e perfil de Administrador ou Editor.")
            ...
            .WithDescription("Atualiza um veículo existente. Requer autenticação e perfil de Administrador.")
            .Produces<Veiculo>(StatusCodes.Status200OK)
            .Produces<ErrosDeValidacao>(StatusCodes.Status400BadRequest)
            .Produces(StatusCodes.Status404NotFound)
            .Produces(StatusCodes.Status401Unauthorized);
            ...
            .WithDescription("Exclui um veículo do sistema. Requer autenticação e perfil de Administrador.")
